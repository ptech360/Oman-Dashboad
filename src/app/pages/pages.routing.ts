...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'view-complaint/program/:programId', loadChildren: () => System.import('./viewcomplaint/view-complaint.module') },  
      { path: 'view-complaint/program-standard/:programId/:standardId', loadChildren: () => System.import('./viewcomplaint/view-complaint.module') },   
